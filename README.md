...
16. On remote devices that you plan on accessing GuyStation from, install the [GuyStation Remote Extension](https://github.com/jamesgrams/guystation-remote-extension). This will allow you to run the scripts you create to execute in the browser on remote devices as well.
